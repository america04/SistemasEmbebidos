...
# Asegúrate de cambiar '/dev/ttyACM0' por el puerto correcto en tu Raspberry Pi
# Puedes encontrarlo ejecutando 'ls /dev/tty*' en la terminal
try:
...
# --- UMBRALES Y TIEMPOS (¡Ajusta estos valores en tus pruebas!) ---
EAR_UMBRAL = 0.25      # Si el EAR es menor a esto, el ojo está cerrado
MAR_UMBRAL = 0.5       # Si el MAR es mayor a esto, está bostezando
...
# --- ÍNDICES DE PUNTOS FACIALES (LANDMARKS) ---
# Extraídos de la malla de 468 puntos de MediaPipe
